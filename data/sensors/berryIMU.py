...
import time
import math
from data.sensors.gyro_accel_compass import IMU
import datetime
import os
...
def accMagGyData():
    ...
    global a
    global oldXMagRawValue, oldYMagRawValue, oldZMagRawValue
    global oldXAccRawValue, oldYAccRawValue, oldZAccRawValue 
    global acc_medianTable1X, acc_medianTable1Y, acc_medianTable1Z 
    global acc_medianTable2X, acc_medianTable2Y, acc_medianTable2Z 
    global mag_medianTable1X, mag_medianTable1Y, mag_medianTable1Z 
    global mag_medianTable2X, mag_medianTable2Y, mag_medianTable2Z 
    global gyroXangle, gyroYangle, gyroZangle 
    global CFangleX, CFangleY, CFangleXFiltered, CFangleYFiltered
    ...
    return roll, pitch, tiltCompensatedHeading
    #print(outputString)
